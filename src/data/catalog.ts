...
function product(input: {
  ...
  return {
    ...
    images: [{ url: input.image, alt: input.displayName, position: 0 }],
    status: "active",
...
export const products: Product[] = [
  product({ id: "oatmeal-knit", slug: "oatmeal-knit-sweater", name: "Oatmeal Knit Sweater", displayName: "Sweater tejido avena", description: "Sweater de algodón orgánico con textura suave para uso diario.", material: "100% algodón orgánico", color: "Oat", price: 185, stock: 18, badge: "Nuevo", category: "Abrigos", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAiOyZM2J1ULAHxuxU-UMOdUlTghJyvuHwOrIwmTg4z1bhbD08cQIqn9h98xB7-L42AUZyuj_ls6HV8GIMYGAVHlz7VESXHaB5MQlf19gYUgEHwnnhM5ZjEudGvlnEjlTWhJN7HdtHp4ChNFQa_oBmNhjjGqA8ap4EcUtvCF1TMXzIUCFJRdk9vWM_j8gSQfKiT-iKitS7zIr15fOGWiytXoJ9YCh070SQvekkNIn2Eral0cngHSFJpBeFdJe2oIwly3QOEf3GMK4h4" }),
  product({ id: "classic-linen", slug: "artisan-linen-shirt", name: "Classic Linen Shirt", displayName: "Camisa de lino artesanal", description: "Camisa de lino europeo, liviana y respirable para temporadas cálidas.", material: "Lino europeo", color: "Sand", price: 140, stock: 24, category: "Camisas", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuA2S6qUq16B1qGPx74voz18Wulmyqqybvl-fZ58Qos6mIJgTAhkiAVlE9NR6tmdL6XxmppYz4znZaVRMnzo9RLwE77bts6RwNzzcQ-tzbRUpELW9sGlcb0gI9fgPeyAMoi1pacYChLKeD-mgli2swVUlQvQNUH4J3-IXGBdo9izcVSQEi3xCZ_GpJlp38TFVnDOwNC5UEXGa2dBU2GdKsuFHg0b8T3po4R7B1msR3qdDFbZTfLIeXWCzJCbAT_b15dyQJsAq4B0z7pv" }),
  product({ id: "fluid-trouser", slug: "fluid-drape-trouser", name: "Fluid Drape Trouser", displayName: "Pantalón fluido", description: "Pantalón de caída amplia en mezcla de lyocell para movimiento natural.", material: "Mezcla de lyocell Tencel", color: "Sage", price: 165, stock: 16, category: "Pantalones", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuAYZxs1RKzAIhWLrIGRMp4fBXdh_OCWzwF_zhne2uXe-u0YPoXcfdYTrX9Ixl5KwhJQ1rSMo8tDQGSCE3qNZyiBj8WI1XhH7vrjGLt3-_8npnYfDXdSOMC2zAZea5PDheh_XJp30u18wlSK7fN5GeIPl4OPlkpsc3tEgRs2EyphyCmYySj6UiWXl-oQjPKQTgorIq62e2C39nax17DOUHINRHQ-LGGFBFsRUAM58KG_yPCUluMIrinkjBS8WGwy7qTbZPc7WWt9K59Y" }),
  ...
  product({ id: "midi-dress", slug: "draped-linen-midi-dress", name: "Draped Linen Midi Dress", displayName: "Vestido midi de lino drapeado", description: "Vestido midi de lino con drapeado suave y silueta atemporal.", material: "Lino", color: "Off-White", price: 195, stock: 9, badge: "Más vendido", category: "Vestidos", image: "https://lh3.googleusercontent.com/aida-public/AB6AXuDYosaipP_PqAiLeinmIl0q97k8Z1MK5w69JCLeL2NhjIrsTmxe0QT_IB_Mc-wHmGiuqh6jQYls9liqPgx0VwUhJyGxJAgnT89HI1rxMzKStGRRWhtimQFPbonJqeI5j6UatinLfkTB4vguupsup0xm3b5NKlA-FSCuqJLKDcuLz_9kA8lJR5IzfMdPw56YYun23_wm-tjDKLnTb8XlbReqrSvV94GzkbjjHIZoczlFGQiBd2Gu8IrhzQ75JhDSbjS2SCrTsW9Cu72w" }),
